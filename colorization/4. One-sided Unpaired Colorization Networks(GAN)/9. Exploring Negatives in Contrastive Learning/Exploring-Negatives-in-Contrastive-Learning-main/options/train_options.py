...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        #add
        parser.add_argument('--ib_aphla', type=float, default=0.1, help='term of ibloss')
        
        parser.add_argument('--choose_patch', type=int, default=0, help='choose sort patches or not')
        parser.add_argument('--no_sort_nums', type=int, default=0, help='choose sort patches or not')
        # training parameters
