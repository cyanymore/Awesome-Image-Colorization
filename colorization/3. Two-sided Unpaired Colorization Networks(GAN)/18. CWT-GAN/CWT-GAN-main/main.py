...
def parse_args():
    desc = "Pytorch implementation of CWT-GAN"
    parser = argparse.ArgumentParser(description=desc)
    parser.add_argument('--phase', type=str, default='train', help='[train / test]')
    parser.add_argument('--light', type=str2bool, default=False, help='[CWT-GAN full version / CWT-GAN light version]')
    parser.add_argument('--dataset', type=str, default='YOUR_DATASET_NAME', help='dataset_name')

    parser.add_argument('--iteration', type=int, default=100001, help='The number of training iterations')
    ...
    parser.add_argument('--beta', type=float, default=1.0, help='Weight for D')
    ...
    parser.add_argument('--device', type=str, default='cuda', help='Set gpu mode; [cpu, cuda]')
