...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, gpu_ids=[]):
    ...
    if which_model_netG == 'resnet_12blocks':
        ...
        netG =R2AttU_Net(img_ch=3,output_ch=3,t=2)  #ResnetGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids)
