...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--gan_type', type=str, default='lsgan', help='selects gantype to use for discriminator network')
        ...
        self.parser.add_argument('--which_direction', type=str, default='AtoB', help='BtoA or BtoA')
