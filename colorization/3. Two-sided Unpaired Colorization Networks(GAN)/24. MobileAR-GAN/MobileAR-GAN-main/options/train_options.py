...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_CS_A', type=float, default=1.0, help='weight for cyclic-synthesized loss between fake A and reconstructed A ')
        self.parser.add_argument('--lambda_CS_B', type=float, default=1.0, help='weight for cyclic-synthesized loss between fake B and reconstucted B ')
        self.parser.add_argument('--lambda_feat_fArecA', type=float, default=1.0, help='weight for perception loss between fake A and reconstructed A ')
        self.parser.add_argument('--lambda_feat_fBrecB', type=float, default=1.0, help='weight for perception loss between fake B and reconstructed B ')
