...
class Pix2PixModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_L1', 'G_Syn', 'D_real', 'D_fake']
    ...
    def backward_G(self):
        ...
        # Synthesized loss
        l = 15
        self.loss_G_Syn = self.criterionSyn(self.fake_B, self.real_B) * l
        ...
        self.loss_G = self.loss_G_GAN * self.w_gan + self.loss_G_L1 + self.loss_vgg * self.w_vgg + self.tv_loss * self.w_tv + self.loss_G_Syn
        # self.loss_G = self.loss_G_GAN * self.w_gan + self.loss_G_L1 + self.loss_vgg * self.w_vgg + self.loss_G_Syn
